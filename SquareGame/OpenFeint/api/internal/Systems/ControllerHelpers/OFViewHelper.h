...
public:
	...
	static void setAsDelegateForAllTextFields(id<UITextFieldDelegate, UITextViewDelegate> delegate, UIView* rootView);
	...
	static UIFont* getFontToFitStringInSize(NSString * text, CGSize size, UIFont const* font, uint maxFontSize, uint minFontSize);
